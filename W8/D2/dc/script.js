...
const inventory = [
  ...
  (function getCarHonda(carInventory) {
    for (e of carInventory) {
      if (e.car_make === "Honda") {
        return `This is a ${e.car_make} ${e.car_model} from ${e.car_year}`;
      }
    }
  })(inventory);
  // Part II
  
  // Create a function sortCarInventoryByYear(carInventory) that takes a single parameter. carInventory‘s
